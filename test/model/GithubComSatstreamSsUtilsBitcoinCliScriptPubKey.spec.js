...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliScriptPubKey', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliScriptPubKey();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliScriptPubKey', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliScriptPubKey
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliScriptPubKey);
      });
