...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionOutput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.TransactionOutput();
      });

      it('should create an instance of TransactionOutput', function() {
        // TODO: update the code to test TransactionOutput
        expect(instance).to.be.a(SatstreamJavascriptSdk.TransactionOutput);
      });
