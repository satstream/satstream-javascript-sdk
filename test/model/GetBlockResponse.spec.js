...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetBlockResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GetBlockResponse();
      });

      it('should create an instance of GetBlockResponse', function() {
        // TODO: update the code to test GetBlockResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GetBlockResponse);
      });
