...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlock3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock3();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlock3', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlock3
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock3);
      });
