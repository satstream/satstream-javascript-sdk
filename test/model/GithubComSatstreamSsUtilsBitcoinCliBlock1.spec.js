...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlock1', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock1();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlock1', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlock1
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock1);
      });
