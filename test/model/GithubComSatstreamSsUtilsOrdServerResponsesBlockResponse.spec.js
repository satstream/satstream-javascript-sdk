...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesBlockResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesBlockResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesBlockResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesBlockResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesBlockResponse);
      });
