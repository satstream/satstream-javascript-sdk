...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RawTx1', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RawTx1();
      });

      it('should create an instance of RawTx1', function() {
        // TODO: update the code to test RawTx1
        expect(instance).to.be.a(SatstreamJavascriptSdk.RawTx1);
      });
