...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksGetBlockInfo', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksGetBlockInfo();
      });

      it('should create an instance of BlocksGetBlockInfo', function() {
        // TODO: update the code to test BlocksGetBlockInfo
        expect(instance).to.be.a(SatstreamApi.BlocksGetBlockInfo);
      });
