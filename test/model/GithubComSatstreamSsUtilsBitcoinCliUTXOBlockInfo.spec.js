...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliUTXOBlockInfo', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliUTXOBlockInfo();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliUTXOBlockInfo', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliUTXOBlockInfo
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliUTXOBlockInfo);
      });
