...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RpcScriptSig', function() {
      beforeEach(function() {
        instance = new SatstreamApi.RpcScriptSig();
      });

      it('should create an instance of RpcScriptSig', function() {
        // TODO: update the code to test RpcScriptSig
        expect(instance).to.be.a(SatstreamApi.RpcScriptSig);
      });
