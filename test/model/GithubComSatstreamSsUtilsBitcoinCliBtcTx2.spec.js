...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBtcTx2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBtcTx2();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBtcTx2', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBtcTx2
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBtcTx2);
      });
