...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesTransactionDetails', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransactionDetails();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesTransactionDetails', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesTransactionDetails
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransactionDetails);
      });
