...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesOutputResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesOutputResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesOutputResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesOutputResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesOutputResponse);
      });
