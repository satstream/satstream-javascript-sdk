...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RuneListEntry', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RuneListEntry();
      });

      it('should create an instance of RuneListEntry', function() {
        // TODO: update the code to test RuneListEntry
        expect(instance).to.be.a(SatstreamJavascriptSdk.RuneListEntry);
      });
