...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliFeeRange', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliFeeRange();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliFeeRange', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliFeeRange
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliFeeRange);
      });
