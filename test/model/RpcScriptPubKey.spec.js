...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RpcScriptPubKey', function() {
      beforeEach(function() {
        instance = new SatstreamApi.RpcScriptPubKey();
      });

      it('should create an instance of RpcScriptPubKey', function() {
        // TODO: update the code to test RpcScriptPubKey
        expect(instance).to.be.a(SatstreamApi.RpcScriptPubKey);
      });
