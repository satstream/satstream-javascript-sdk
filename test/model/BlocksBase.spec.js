...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksBase', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksBase();
      });

      it('should create an instance of BlocksBase', function() {
        // TODO: update the code to test BlocksBase
        expect(instance).to.be.a(SatstreamApi.BlocksBase);
      });
