...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksGetFeesData', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksGetFeesData();
      });

      it('should create an instance of BlocksGetFeesData', function() {
        // TODO: update the code to test BlocksGetFeesData
        expect(instance).to.be.a(SatstreamApi.BlocksGetFeesData);
      });
