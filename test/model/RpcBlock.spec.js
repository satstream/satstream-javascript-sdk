...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RpcBlock', function() {
      beforeEach(function() {
        instance = new SatstreamApi.RpcBlock();
      });

      it('should create an instance of RpcBlock', function() {
        // TODO: update the code to test RpcBlock
        expect(instance).to.be.a(SatstreamApi.RpcBlock);
      });
