...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsCreatePSBTRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsCreatePSBTRequest();
      });

      it('should create an instance of RequestsCreatePSBTRequest', function() {
        // TODO: update the code to test RequestsCreatePSBTRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsCreatePSBTRequest);
      });
