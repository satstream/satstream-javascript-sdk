...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TxSpendingPrevoutInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.TxSpendingPrevoutInput();
      });

      it('should create an instance of TxSpendingPrevoutInput', function() {
        // TODO: update the code to test TxSpendingPrevoutInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.TxSpendingPrevoutInput);
      });
