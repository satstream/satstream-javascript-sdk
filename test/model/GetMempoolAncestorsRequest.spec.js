...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetMempoolAncestorsRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GetMempoolAncestorsRequest();
      });

      it('should create an instance of GetMempoolAncestorsRequest', function() {
        // TODO: update the code to test GetMempoolAncestorsRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.GetMempoolAncestorsRequest);
      });
