...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResponsesGetFeesResponse', function() {
      beforeEach(function() {
        instance = new SatstreamApi.ResponsesGetFeesResponse();
      });

      it('should create an instance of ResponsesGetFeesResponse', function() {
        // TODO: update the code to test ResponsesGetFeesResponse
        expect(instance).to.be.a(SatstreamApi.ResponsesGetFeesResponse);
      });
