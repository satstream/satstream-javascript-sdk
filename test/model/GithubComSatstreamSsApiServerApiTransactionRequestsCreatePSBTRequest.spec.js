...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTRequest();
      });

      it('should create an instance of GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTRequest', function() {
        // TODO: update the code to test GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTRequest);
      });
