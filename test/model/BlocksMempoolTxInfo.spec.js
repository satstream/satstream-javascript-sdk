...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksMempoolTxInfo', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksMempoolTxInfo();
      });

      it('should create an instance of BlocksMempoolTxInfo', function() {
        // TODO: update the code to test BlocksMempoolTxInfo
        expect(instance).to.be.a(SatstreamApi.BlocksMempoolTxInfo);
      });
