...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliVout', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliVout();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliVout', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliVout
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliVout);
      });
