...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesRuneEntry', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesRuneEntry();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesRuneEntry', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesRuneEntry
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesRuneEntry);
      });
