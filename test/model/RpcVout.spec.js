...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RpcVout', function() {
      beforeEach(function() {
        instance = new SatstreamApi.RpcVout();
      });

      it('should create an instance of RpcVout', function() {
        // TODO: update the code to test RpcVout
        expect(instance).to.be.a(SatstreamApi.RpcVout);
      });
