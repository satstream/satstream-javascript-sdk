...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBtcTx3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBtcTx3();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBtcTx3', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBtcTx3
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBtcTx3);
      });
