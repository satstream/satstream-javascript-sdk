...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeeHorizonEstimate', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.FeeHorizonEstimate();
      });

      it('should create an instance of FeeHorizonEstimate', function() {
        // TODO: update the code to test FeeHorizonEstimate
        expect(instance).to.be.a(SatstreamJavascriptSdk.FeeHorizonEstimate);
      });
