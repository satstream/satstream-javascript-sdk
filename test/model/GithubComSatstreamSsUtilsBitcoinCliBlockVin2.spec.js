...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlockVin2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockVin2();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlockVin2', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlockVin2
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockVin2);
      });
