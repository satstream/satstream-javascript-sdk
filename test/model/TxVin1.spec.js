...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TxVin1', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.TxVin1();
      });

      it('should create an instance of TxVin1', function() {
        // TODO: update the code to test TxVin1
        expect(instance).to.be.a(SatstreamJavascriptSdk.TxVin1);
      });
