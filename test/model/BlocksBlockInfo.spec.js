...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksBlockInfo', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksBlockInfo();
      });

      it('should create an instance of BlocksBlockInfo', function() {
        // TODO: update the code to test BlocksBlockInfo
        expect(instance).to.be.a(SatstreamApi.BlocksBlockInfo);
      });
