...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RunesBalance', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RunesBalance();
      });

      it('should create an instance of RunesBalance', function() {
        // TODO: update the code to test RunesBalance
        expect(instance).to.be.a(SatstreamJavascriptSdk.RunesBalance);
      });
