...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RawMempoolData', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RawMempoolData();
      });

      it('should create an instance of RawMempoolData', function() {
        // TODO: update the code to test RawMempoolData
        expect(instance).to.be.a(SatstreamJavascriptSdk.RawMempoolData);
      });
