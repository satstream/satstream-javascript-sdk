...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsGetMempoolDescendantsRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsGetMempoolDescendantsRequest();
      });

      it('should create an instance of RequestsGetMempoolDescendantsRequest', function() {
        // TODO: update the code to test RequestsGetMempoolDescendantsRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsGetMempoolDescendantsRequest);
      });
