...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Block3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.Block3();
      });

      it('should create an instance of Block3', function() {
        // TODO: update the code to test Block3
        expect(instance).to.be.a(SatstreamJavascriptSdk.Block3);
      });
