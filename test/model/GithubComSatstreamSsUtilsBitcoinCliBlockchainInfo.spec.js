...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlockchainInfo', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockchainInfo();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlockchainInfo', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlockchainInfo
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockchainInfo);
      });
