...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliPSBTAnalysis', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliPSBTAnalysis();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliPSBTAnalysis', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliPSBTAnalysis
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliPSBTAnalysis);
      });
