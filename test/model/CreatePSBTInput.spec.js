...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreatePSBTInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.CreatePSBTInput();
      });

      it('should create an instance of CreatePSBTInput', function() {
        // TODO: update the code to test CreatePSBTInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.CreatePSBTInput);
      });
