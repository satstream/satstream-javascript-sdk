...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliDecodedPSBTInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliDecodedPSBTInput();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliDecodedPSBTInput', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliDecodedPSBTInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliDecodedPSBTInput);
      });
