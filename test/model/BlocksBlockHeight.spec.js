...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksBlockHeight', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksBlockHeight();
      });

      it('should create an instance of BlocksBlockHeight', function() {
        // TODO: update the code to test BlocksBlockHeight
        expect(instance).to.be.a(SatstreamApi.BlocksBlockHeight);
      });
