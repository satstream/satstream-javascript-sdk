...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsGetBlockStatsRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsGetBlockStatsRequest();
      });

      it('should create an instance of RequestsGetBlockStatsRequest', function() {
        // TODO: update the code to test RequestsGetBlockStatsRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsGetBlockStatsRequest);
      });
