...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsGetMempoolAncestorsRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsGetMempoolAncestorsRequest();
      });

      it('should create an instance of RequestsGetMempoolAncestorsRequest', function() {
        // TODO: update the code to test RequestsGetMempoolAncestorsRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsGetMempoolAncestorsRequest);
      });
