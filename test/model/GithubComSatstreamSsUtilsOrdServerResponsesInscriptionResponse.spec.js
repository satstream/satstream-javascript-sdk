...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesInscriptionResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesInscriptionResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesInscriptionResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesInscriptionResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesInscriptionResponse);
      });
