...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RpcVin', function() {
      beforeEach(function() {
        instance = new SatstreamApi.RpcVin();
      });

      it('should create an instance of RpcVin', function() {
        // TODO: update the code to test RpcVin
        expect(instance).to.be.a(SatstreamApi.RpcVin);
      });
