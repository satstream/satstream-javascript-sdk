...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StoreTransactionDocument', function() {
      beforeEach(function() {
        instance = new SatstreamApi.StoreTransactionDocument();
      });

      it('should create an instance of StoreTransactionDocument', function() {
        // TODO: update the code to test StoreTransactionDocument
        expect(instance).to.be.a(SatstreamApi.StoreTransactionDocument);
      });
