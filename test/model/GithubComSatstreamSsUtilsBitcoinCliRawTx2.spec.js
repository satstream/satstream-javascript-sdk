...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliRawTx2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliRawTx2();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliRawTx2', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliRawTx2
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliRawTx2);
      });
