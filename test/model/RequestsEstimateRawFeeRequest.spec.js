...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsEstimateRawFeeRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsEstimateRawFeeRequest();
      });

      it('should create an instance of RequestsEstimateRawFeeRequest', function() {
        // TODO: update the code to test RequestsEstimateRawFeeRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsEstimateRawFeeRequest);
      });
