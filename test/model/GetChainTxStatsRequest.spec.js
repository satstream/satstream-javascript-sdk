...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetChainTxStatsRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GetChainTxStatsRequest();
      });

      it('should create an instance of GetChainTxStatsRequest', function() {
        // TODO: update the code to test GetChainTxStatsRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.GetChainTxStatsRequest);
      });
