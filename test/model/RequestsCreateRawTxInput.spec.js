...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsCreateRawTxInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsCreateRawTxInput();
      });

      it('should create an instance of RequestsCreateRawTxInput', function() {
        // TODO: update the code to test RequestsCreateRawTxInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsCreateRawTxInput);
      });
