...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResponsesBase', function() {
      beforeEach(function() {
        instance = new SatstreamApi.ResponsesBase();
      });

      it('should create an instance of ResponsesBase', function() {
        // TODO: update the code to test ResponsesBase
        expect(instance).to.be.a(SatstreamApi.ResponsesBase);
      });
