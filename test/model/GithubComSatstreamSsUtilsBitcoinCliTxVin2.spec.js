...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliTxVin2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTxVin2();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliTxVin2', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliTxVin2
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTxVin2);
      });
