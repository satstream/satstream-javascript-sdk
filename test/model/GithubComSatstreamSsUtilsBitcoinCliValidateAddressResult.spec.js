...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliValidateAddressResult', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliValidateAddressResult();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliValidateAddressResult', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliValidateAddressResult
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliValidateAddressResult);
      });
