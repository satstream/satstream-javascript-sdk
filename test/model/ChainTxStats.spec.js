...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChainTxStats', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.ChainTxStats();
      });

      it('should create an instance of ChainTxStats', function() {
        // TODO: update the code to test ChainTxStats
        expect(instance).to.be.a(SatstreamJavascriptSdk.ChainTxStats);
      });
