...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionGetTxOutProofRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.TransactionGetTxOutProofRequest();
      });

      it('should create an instance of TransactionGetTxOutProofRequest', function() {
        // TODO: update the code to test TransactionGetTxOutProofRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.TransactionGetTxOutProofRequest);
      });
