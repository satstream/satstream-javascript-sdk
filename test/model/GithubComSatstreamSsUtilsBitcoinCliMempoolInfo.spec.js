...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliMempoolInfo', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliMempoolInfo();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliMempoolInfo', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliMempoolInfo
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliMempoolInfo);
      });
