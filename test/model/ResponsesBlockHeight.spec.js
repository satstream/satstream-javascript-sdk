...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResponsesBlockHeight', function() {
      beforeEach(function() {
        instance = new SatstreamApi.ResponsesBlockHeight();
      });

      it('should create an instance of ResponsesBlockHeight', function() {
        // TODO: update the code to test ResponsesBlockHeight
        expect(instance).to.be.a(SatstreamApi.ResponsesBlockHeight);
      });
