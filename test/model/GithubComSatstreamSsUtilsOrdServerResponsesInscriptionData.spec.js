...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesInscriptionData', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesInscriptionData();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesInscriptionData', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesInscriptionData
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesInscriptionData);
      });
