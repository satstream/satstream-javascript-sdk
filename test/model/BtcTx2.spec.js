...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BtcTx2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.BtcTx2();
      });

      it('should create an instance of BtcTx2', function() {
        // TODO: update the code to test BtcTx2
        expect(instance).to.be.a(SatstreamJavascriptSdk.BtcTx2);
      });
