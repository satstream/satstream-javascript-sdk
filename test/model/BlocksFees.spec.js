...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksFees', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksFees();
      });

      it('should create an instance of BlocksFees', function() {
        // TODO: update the code to test BlocksFees
        expect(instance).to.be.a(SatstreamApi.BlocksFees);
      });
