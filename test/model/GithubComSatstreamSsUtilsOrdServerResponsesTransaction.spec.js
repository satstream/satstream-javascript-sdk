...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesTransaction', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransaction();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesTransaction', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesTransaction
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransaction);
      });
