...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Block2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.Block2();
      });

      it('should create an instance of Block2', function() {
        // TODO: update the code to test Block2
        expect(instance).to.be.a(SatstreamJavascriptSdk.Block2);
      });
