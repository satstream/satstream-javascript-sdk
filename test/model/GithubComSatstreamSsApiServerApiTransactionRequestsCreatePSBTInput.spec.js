...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTInput();
      });

      it('should create an instance of GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTInput', function() {
        // TODO: update the code to test GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiTransactionRequestsCreatePSBTInput);
      });
