...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsCreatePSBTInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsCreatePSBTInput();
      });

      it('should create an instance of RequestsCreatePSBTInput', function() {
        // TODO: update the code to test RequestsCreatePSBTInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsCreatePSBTInput);
      });
