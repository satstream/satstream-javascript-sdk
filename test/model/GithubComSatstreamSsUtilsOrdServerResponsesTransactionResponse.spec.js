...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesTransactionResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransactionResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesTransactionResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesTransactionResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesTransactionResponse);
      });
