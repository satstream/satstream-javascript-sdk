...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliTxSpendingPrevoutResult', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTxSpendingPrevoutResult();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliTxSpendingPrevoutResult', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliTxSpendingPrevoutResult
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTxSpendingPrevoutResult);
      });
