...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsStoreTransactionDocument', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsStoreTransactionDocument();
      });

      it('should create an instance of GithubComSatstreamSsUtilsStoreTransactionDocument', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsStoreTransactionDocument
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsStoreTransactionDocument);
      });
