...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsStoreTransactionDocument', function() {
      beforeEach(function() {
        instance = new SatstreamApi.GithubComSatstreamSsUtilsStoreTransactionDocument();
      });
      ...
      it('should create an instance of GithubComSatstreamSsUtilsStoreTransactionDocument', function() {
        ...
        expect(instance).to.be.a(SatstreamApi.GithubComSatstreamSsUtilsStoreTransactionDocument);
      });
