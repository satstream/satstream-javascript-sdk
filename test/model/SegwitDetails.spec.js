...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SegwitDetails', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.SegwitDetails();
      });

      it('should create an instance of SegwitDetails', function() {
        // TODO: update the code to test SegwitDetails
        expect(instance).to.be.a(SatstreamJavascriptSdk.SegwitDetails);
      });
