...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesSatoshiResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesSatoshiResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesSatoshiResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesSatoshiResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesSatoshiResponse);
      });
