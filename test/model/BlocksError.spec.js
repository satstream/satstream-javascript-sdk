...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksError', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksError();
      });

      it('should create an instance of BlocksError', function() {
        // TODO: update the code to test BlocksError
        expect(instance).to.be.a(SatstreamApi.BlocksError);
      });
