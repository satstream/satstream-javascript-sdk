...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsCreateRawTxRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsCreateRawTxRequest();
      });

      it('should create an instance of RequestsCreateRawTxRequest', function() {
        // TODO: update the code to test RequestsCreateRawTxRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsCreateRawTxRequest);
      });
