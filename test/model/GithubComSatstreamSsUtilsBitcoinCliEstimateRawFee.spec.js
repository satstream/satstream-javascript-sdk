...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliEstimateRawFee', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliEstimateRawFee();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliEstimateRawFee', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliEstimateRawFee
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliEstimateRawFee);
      });
