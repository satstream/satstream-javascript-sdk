...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsGetRawMempoolRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsGetRawMempoolRequest();
      });

      it('should create an instance of RequestsGetRawMempoolRequest', function() {
        // TODO: update the code to test RequestsGetRawMempoolRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsGetRawMempoolRequest);
      });
