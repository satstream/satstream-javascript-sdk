...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlockVin3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.BlockVin3();
      });

      it('should create an instance of BlockVin3', function() {
        // TODO: update the code to test BlockVin3
        expect(instance).to.be.a(SatstreamJavascriptSdk.BlockVin3);
      });
