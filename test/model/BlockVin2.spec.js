...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlockVin2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.BlockVin2();
      });

      it('should create an instance of BlockVin2', function() {
        // TODO: update the code to test BlockVin2
        expect(instance).to.be.a(SatstreamJavascriptSdk.BlockVin2);
      });
