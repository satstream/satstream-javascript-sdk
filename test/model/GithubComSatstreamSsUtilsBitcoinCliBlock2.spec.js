...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlock2', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock2();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlock2', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlock2
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlock2);
      });
