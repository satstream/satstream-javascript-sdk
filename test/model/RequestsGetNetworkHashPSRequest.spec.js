...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsGetNetworkHashPSRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsGetNetworkHashPSRequest();
      });

      it('should create an instance of RequestsGetNetworkHashPSRequest', function() {
        // TODO: update the code to test RequestsGetNetworkHashPSRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsGetNetworkHashPSRequest);
      });
