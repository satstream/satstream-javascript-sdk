...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliDecodedPSBT', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliDecodedPSBT();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliDecodedPSBT', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliDecodedPSBT
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliDecodedPSBT);
      });
