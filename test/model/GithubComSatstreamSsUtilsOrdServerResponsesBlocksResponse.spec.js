...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdServerResponsesBlocksResponse', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesBlocksResponse();
      });

      it('should create an instance of GithubComSatstreamSsUtilsOrdServerResponsesBlocksResponse', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsOrdServerResponsesBlocksResponse
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdServerResponsesBlocksResponse);
      });
