...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliTestMempoolAcceptResult', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTestMempoolAcceptResult();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliTestMempoolAcceptResult', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliTestMempoolAcceptResult
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliTestMempoolAcceptResult);
      });
