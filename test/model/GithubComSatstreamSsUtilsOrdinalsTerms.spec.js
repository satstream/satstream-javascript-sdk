...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsOrdinalsTerms', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdinalsTerms();
      });
      ...
      it('should create an instance of GithubComSatstreamSsUtilsOrdinalsTerms', function() {
        ...
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsOrdinalsTerms);
      });
