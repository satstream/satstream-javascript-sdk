...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrdinalsTermsRange', function() {
      beforeEach(function() {
        instance = new SatstreamApi.OrdinalsTermsRange();
      });

      it('should create an instance of OrdinalsTermsRange', function() {
        // TODO: update the code to test OrdinalsTermsRange
        expect(instance).to.be.a(SatstreamApi.OrdinalsTermsRange);
      });
