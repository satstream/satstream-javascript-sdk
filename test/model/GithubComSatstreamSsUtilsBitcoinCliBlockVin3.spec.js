...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliBlockVin3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockVin3();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliBlockVin3', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliBlockVin3
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliBlockVin3);
      });
