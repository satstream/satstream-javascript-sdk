...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreatePSBTRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.CreatePSBTRequest();
      });

      it('should create an instance of CreatePSBTRequest', function() {
        // TODO: update the code to test CreatePSBTRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.CreatePSBTRequest);
      });
