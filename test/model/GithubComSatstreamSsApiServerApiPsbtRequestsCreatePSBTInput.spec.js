...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsApiServerApiPsbtRequestsCreatePSBTInput', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiPsbtRequestsCreatePSBTInput();
      });

      it('should create an instance of GithubComSatstreamSsApiServerApiPsbtRequestsCreatePSBTInput', function() {
        // TODO: update the code to test GithubComSatstreamSsApiServerApiPsbtRequestsCreatePSBTInput
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsApiServerApiPsbtRequestsCreatePSBTInput);
      });
