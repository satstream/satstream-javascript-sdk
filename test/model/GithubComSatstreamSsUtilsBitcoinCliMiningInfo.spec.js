...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GithubComSatstreamSsUtilsBitcoinCliMiningInfo', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliMiningInfo();
      });

      it('should create an instance of GithubComSatstreamSsUtilsBitcoinCliMiningInfo', function() {
        // TODO: update the code to test GithubComSatstreamSsUtilsBitcoinCliMiningInfo
        expect(instance).to.be.a(SatstreamJavascriptSdk.GithubComSatstreamSsUtilsBitcoinCliMiningInfo);
      });
