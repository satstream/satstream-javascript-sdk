...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BtcTx3', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.BtcTx3();
      });

      it('should create an instance of BtcTx3', function() {
        // TODO: update the code to test BtcTx3
        expect(instance).to.be.a(SatstreamJavascriptSdk.BtcTx3);
      });
