...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrevOut', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.PrevOut();
      });

      it('should create an instance of PrevOut', function() {
        // TODO: update the code to test PrevOut
        expect(instance).to.be.a(SatstreamJavascriptSdk.PrevOut);
      });
