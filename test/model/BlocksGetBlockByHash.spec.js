...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksGetBlockByHash', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksGetBlockByHash();
      });

      it('should create an instance of BlocksGetBlockByHash', function() {
        // TODO: update the code to test BlocksGetBlockByHash
        expect(instance).to.be.a(SatstreamApi.BlocksGetBlockByHash);
      });
