...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksBlockByHash', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksBlockByHash();
      });

      it('should create an instance of BlocksBlockByHash', function() {
        // TODO: update the code to test BlocksBlockByHash
        expect(instance).to.be.a(SatstreamApi.BlocksBlockByHash);
      });
