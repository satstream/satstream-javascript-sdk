...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestsConvertToPSBTRequest', function() {
      beforeEach(function() {
        instance = new SatstreamJavascriptSdk.RequestsConvertToPSBTRequest();
      });

      it('should create an instance of RequestsConvertToPSBTRequest', function() {
        // TODO: update the code to test RequestsConvertToPSBTRequest
        expect(instance).to.be.a(SatstreamJavascriptSdk.RequestsConvertToPSBTRequest);
      });
