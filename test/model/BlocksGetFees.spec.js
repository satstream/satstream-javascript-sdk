...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlocksGetFees', function() {
      beforeEach(function() {
        instance = new SatstreamApi.BlocksGetFees();
      });

      it('should create an instance of BlocksGetFees', function() {
        // TODO: update the code to test BlocksGetFees
        expect(instance).to.be.a(SatstreamApi.BlocksGetFees);
      });
