...
*SatstreamJavascriptSdk.TransactionsApi* | [**getRawTransactionHex**](docs/TransactionsApi.md#getRawTransactionHex) | **GET** /tx/{txid}/raw/hex | Get raw transaction (verbosity 0)
