...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GithubComSatstreamSsUtilsRpcVin', 'model/GithubComSatstreamSsUtilsRpcVout'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GithubComSatstreamSsUtilsRpcVin'), require('./GithubComSatstreamSsUtilsRpcVout'));
  } else {
    // Browser globals (root is window)
    if (!root.SatstreamApi) {
      root.SatstreamApi = {};
    }
    root.SatstreamApi.GithubComSatstreamSsUtilsRpcBtcTx = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.GithubComSatstreamSsUtilsRpcVin, root.SatstreamApi.GithubComSatstreamSsUtilsRpcVout);
  }
}(this, function(ApiClient, GithubComSatstreamSsUtilsRpcVin, GithubComSatstreamSsUtilsRpcVout) {
  'use strict';
