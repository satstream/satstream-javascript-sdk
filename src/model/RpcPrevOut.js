...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SatstreamApi.RpcPrevOut = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.RpcScriptPubKey, root.SatstreamApi.RpcUtxoRune);
  }
}(this, function(ApiClient, RpcScriptPubKey, RpcUtxoRune) {
  'use strict';

  /**
   * The RpcPrevOut model module.
   * @module model/RpcPrevOut
   * @version 1.0
   */

  /**
   * Constructs a new <code>RpcPrevOut</code>.
   * @alias module:model/RpcPrevOut
   * @class
   */
  ...
  /**
   * Constructs a <code>RpcPrevOut</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RpcPrevOut} obj Optional instance to populate.
   * @return {module:model/RpcPrevOut} The populated <code>RpcPrevOut</code> instance.
   */
