...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RpcBtcTx'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RpcBtcTx'));
  } else {
    // Browser globals (root is window)
    if (!root.SatstreamApi) {
      root.SatstreamApi = {};
    }
    root.SatstreamApi.RpcBlock = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.RpcBtcTx);
  }
}(this, function(ApiClient, RpcBtcTx) {
  'use strict';

  /**
   * The RpcBlock model module.
   * @module model/RpcBlock
   * @version 1.0
   */

  /**
   * Constructs a new <code>RpcBlock</code>.
   * @alias module:model/RpcBlock
   * @class
   */
  ...
  /**
   * Constructs a <code>RpcBlock</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RpcBlock} obj Optional instance to populate.
   * @return {module:model/RpcBlock} The populated <code>RpcBlock</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tx'))
        obj.tx = ApiClient.convertToType(data['tx'], [RpcBtcTx]);
   ...
   * @member {Array.<module:model/RpcBtcTx>} tx
   */
