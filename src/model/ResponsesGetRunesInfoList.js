...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResponsesGetRunesInfoListData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResponsesGetRunesInfoListData'));
  } else {
    // Browser globals (root is window)
    if (!root.SatstreamApi) {
      root.SatstreamApi = {};
    }
    root.SatstreamApi.ResponsesGetRunesInfoList = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.ResponsesGetRunesInfoListData);
  }
}(this, function(ApiClient, ResponsesGetRunesInfoListData) {
  'use strict';
