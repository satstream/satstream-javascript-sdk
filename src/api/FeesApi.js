...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GithubComSatstreamSsApiServerApiBlocksResponsesError', 'model/ResponsesGetFees'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GithubComSatstreamSsApiServerApiBlocksResponsesError'), require('../model/ResponsesGetFees'));
  } else {
    // Browser globals (root is window)
    if (!root.SatstreamApi) {
      root.SatstreamApi = {};
    }
    root.SatstreamApi.FeesApi = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.GithubComSatstreamSsApiServerApiBlocksResponsesError, root.SatstreamApi.ResponsesGetFees);
  }
}(this, function(ApiClient, GithubComSatstreamSsApiServerApiBlocksResponsesError, ResponsesGetFees) {
  'use strict';
