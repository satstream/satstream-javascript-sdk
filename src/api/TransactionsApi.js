...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GithubComSatstreamSsApiServerApiTransactionsResponsesBaseResponse', 'model/InlineResponse20010', 'model/InlineResponse20011', 'model/InlineResponse2007'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GithubComSatstreamSsApiServerApiTransactionsResponsesBaseResponse'), require('../model/InlineResponse20010'), require('../model/InlineResponse20011'), require('../model/InlineResponse2007'));
  } else {
    // Browser globals (root is window)
    if (!root.SatstreamApi) {
      root.SatstreamApi = {};
    }
    root.SatstreamApi.TransactionsApi = factory(root.SatstreamApi.ApiClient, root.SatstreamApi.GithubComSatstreamSsApiServerApiTransactionsResponsesBaseResponse, root.SatstreamApi.InlineResponse20010, root.SatstreamApi.InlineResponse20011, root.SatstreamApi.InlineResponse2007);
  }
}(this, function(ApiClient, GithubComSatstreamSsApiServerApiTransactionsResponsesBaseResponse, InlineResponse20010, InlineResponse20011, InlineResponse2007) {
  'use strict';
