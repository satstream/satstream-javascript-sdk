 ...
 * @module models/ResponsesGetAddressRunesBalanceListData
 * @version 1.0
 */
export default class ResponsesGetAddressRunesBalanceListData {
   ...
   * @alias module:models/ResponsesGetAddressRunesBalanceListData
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/ResponsesGetAddressRunesBalanceListData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressRunesBalanceListData} The populated <code>ResponsesGetAddressRunesBalanceListData</code> instance.
   */
...
/**
 * @member {Array.<module:models/ResponsesGetAddressRunesBalanceListItem>} items
 */
