...
export default class ResponsesGetAddressTimeframeBalance {
   ...
   * @param {module:models/ResponsesGetAddressTimeframeBalance} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressTimeframeBalance} The populated <code>ResponsesGetAddressTimeframeBalance</code> instance.
   */
...
/**
 * @member {module:models/ResponsesGetAddressTimeframeBalanceData} data
 */
