...
export default class ResponsesGetBlockByHash {
   ...
   * @param {module:models/ResponsesGetBlockByHash} obj Optional instance to populate.
   * @return {module:models/ResponsesGetBlockByHash} The populated <code>ResponsesGetBlockByHash</code> instance.
   */
...
/**
 * @member {module:models/GithubComSatstreamSsUtilsRpcBlock} data
 */
