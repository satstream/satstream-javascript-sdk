...
export default class ResponsesGetMempoolTxInfo {
   ...
   * @param {module:models/ResponsesGetMempoolTxInfo} obj Optional instance to populate.
   * @return {module:models/ResponsesGetMempoolTxInfo} The populated <code>ResponsesGetMempoolTxInfo</code> instance.
   */
...
/**
 * @member {module:models/GithubComSatstreamSsUtilsRpcBtcTx} data
 */
