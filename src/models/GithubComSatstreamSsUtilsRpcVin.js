...
export default class GithubComSatstreamSsUtilsRpcVin {
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcVin} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcVin} The populated <code>GithubComSatstreamSsUtilsRpcVin</code> instance.
   */
...
/**
 * @member {module:models/GithubComSatstreamSsUtilsRpcPrevOut} prevout
 */
GithubComSatstreamSsUtilsRpcVin.prototype.prevout = undefined;

/**
 * @member {module:models/GithubComSatstreamSsUtilsRpcScriptSig} scriptSig
 */
