 ...
 * @module models/ResponsesGetAddressTimeframeBalanceItem
 * @version 1.0
 */
export default class ResponsesGetAddressTimeframeBalanceItem {
   ...
   * @alias module:models/ResponsesGetAddressTimeframeBalanceItem
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/ResponsesGetAddressTimeframeBalanceItem} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressTimeframeBalanceItem} The populated <code>ResponsesGetAddressTimeframeBalanceItem</code> instance.
   */
