...
export default class ResponsesRuneInfo {
   ...
   * @param {module:models/ResponsesRuneInfo} obj Optional instance to populate.
   * @return {module:models/ResponsesRuneInfo} The populated <code>ResponsesRuneInfo</code> instance.
   */
...
/**
 * @member {module:models/BigInt} premine
 */
...
/**
 * @member {module:models/GithubComSatstreamSsUtilsOrdinalsTerms} terms
 */
