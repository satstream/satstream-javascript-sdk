...
export default class ResponsesGetFeesData {
   ...
   * @param {module:models/ResponsesGetFeesData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetFeesData} The populated <code>ResponsesGetFeesData</code> instance.
   */
