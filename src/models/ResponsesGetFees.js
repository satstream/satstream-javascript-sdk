...
export default class ResponsesGetFees {
   ...
   * @param {module:models/ResponsesGetFees} obj Optional instance to populate.
   * @return {module:models/ResponsesGetFees} The populated <code>ResponsesGetFees</code> instance.
   */
...
/**
 * @member {module:models/ResponsesGetFeesData} data
 */
