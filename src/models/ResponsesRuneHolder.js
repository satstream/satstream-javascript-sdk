...
export default class ResponsesRuneHolder {
   ...
   * @param {module:models/ResponsesRuneHolder} obj Optional instance to populate.
   * @return {module:models/ResponsesRuneHolder} The populated <code>ResponsesRuneHolder</code> instance.
   */
