...
export default class ResponsesGetAddressRunesBalanceList {
   ...
   * @param {module:models/ResponsesGetAddressRunesBalanceList} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressRunesBalanceList} The populated <code>ResponsesGetAddressRunesBalanceList</code> instance.
   */
...
/**
 * @member {module:models/ResponsesGetAddressRunesBalanceListData} data
 */
