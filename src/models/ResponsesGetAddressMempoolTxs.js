...
export default class ResponsesGetAddressMempoolTxs {
   ...
   * @param {module:models/ResponsesGetAddressMempoolTxs} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressMempoolTxs} The populated <code>ResponsesGetAddressMempoolTxs</code> instance.
   */
