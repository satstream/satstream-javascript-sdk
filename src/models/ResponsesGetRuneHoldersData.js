...
export default class ResponsesGetRuneHoldersData {
   ...
   * @param {module:models/ResponsesGetRuneHoldersData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetRuneHoldersData} The populated <code>ResponsesGetRuneHoldersData</code> instance.
   */
...
/**
 * @member {Array.<module:models/ResponsesRuneHolder>} holders
 */
