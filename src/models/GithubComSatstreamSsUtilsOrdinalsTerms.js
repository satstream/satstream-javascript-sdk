 ...
 * @module models/GithubComSatstreamSsUtilsOrdinalsTerms
 * @version 1.0
 */
export default class GithubComSatstreamSsUtilsOrdinalsTerms {
   ...
   * @alias module:models/GithubComSatstreamSsUtilsOrdinalsTerms
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/GithubComSatstreamSsUtilsOrdinalsTerms} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsOrdinalsTerms} The populated <code>GithubComSatstreamSsUtilsOrdinalsTerms</code> instance.
   */
...
/**
 * @member {module:models/BigInt} amount
 */
GithubComSatstreamSsUtilsOrdinalsTerms.prototype.amount = undefined;

/**
 * @member {module:models/BigInt} cap
 */
GithubComSatstreamSsUtilsOrdinalsTerms.prototype.cap = undefined;

/**
 * @member {module:models/GithubComSatstreamSsUtilsOrdinalsTermsRange} height
 */
GithubComSatstreamSsUtilsOrdinalsTerms.prototype.height = undefined;

/**
 * @member {module:models/GithubComSatstreamSsUtilsOrdinalsTermsRange} offset
 */
