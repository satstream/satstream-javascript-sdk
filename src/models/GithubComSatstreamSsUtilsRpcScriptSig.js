 ...
 * @module models/GithubComSatstreamSsUtilsRpcScriptSig
 * @version 1.0
 */
export default class GithubComSatstreamSsUtilsRpcScriptSig {
   ...
   * @alias module:models/GithubComSatstreamSsUtilsRpcScriptSig
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcScriptSig} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcScriptSig} The populated <code>GithubComSatstreamSsUtilsRpcScriptSig</code> instance.
   */
