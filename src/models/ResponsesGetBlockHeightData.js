...
export default class ResponsesGetBlockHeightData {
   ...
   * @param {module:models/ResponsesGetBlockHeightData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetBlockHeightData} The populated <code>ResponsesGetBlockHeightData</code> instance.
   */
