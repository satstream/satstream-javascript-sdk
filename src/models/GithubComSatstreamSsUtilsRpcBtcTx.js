...
export default class GithubComSatstreamSsUtilsRpcBtcTx {
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcBtcTx} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcBtcTx} The populated <code>GithubComSatstreamSsUtilsRpcBtcTx</code> instance.
   */
 ...
 * @member {Array.<module:models/GithubComSatstreamSsUtilsRpcVin>} vin
 */
GithubComSatstreamSsUtilsRpcBtcTx.prototype.vin = undefined;

/**
 * Vout will be stored in a separate collection in the DB
 * @member {Array.<module:models/GithubComSatstreamSsUtilsRpcVout>} vout
 */
