...
export default class ResponsesGetTransaction {
   ...
   * @param {module:models/ResponsesGetTransaction} obj Optional instance to populate.
   * @return {module:models/ResponsesGetTransaction} The populated <code>ResponsesGetTransaction</code> instance.
   */
