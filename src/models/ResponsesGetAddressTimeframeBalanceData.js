 ...
 * @module models/ResponsesGetAddressTimeframeBalanceData
 * @version 1.0
 */
export default class ResponsesGetAddressTimeframeBalanceData {
   ...
   * @alias module:models/ResponsesGetAddressTimeframeBalanceData
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/ResponsesGetAddressTimeframeBalanceData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressTimeframeBalanceData} The populated <code>ResponsesGetAddressTimeframeBalanceData</code> instance.
   */
...
/**
 * @member {Array.<module:models/ResponsesGetAddressTimeframeBalanceItem>} items
 */
