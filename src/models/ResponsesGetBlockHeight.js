...
export default class ResponsesGetBlockHeight {
   ...
   * @param {module:models/ResponsesGetBlockHeight} obj Optional instance to populate.
   * @return {module:models/ResponsesGetBlockHeight} The populated <code>ResponsesGetBlockHeight</code> instance.
   */
...
/**
 * @member {module:models/ResponsesGetBlockHeightData} data
 */
