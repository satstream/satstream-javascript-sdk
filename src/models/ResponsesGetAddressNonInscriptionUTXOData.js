 ...
 * @module models/ResponsesGetAddressNonInscriptionUTXOData
 * @version 1.0
 */
export default class ResponsesGetAddressNonInscriptionUTXOData {
   ...
   * @alias module:models/ResponsesGetAddressNonInscriptionUTXOData
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/ResponsesGetAddressNonInscriptionUTXOData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressNonInscriptionUTXOData} The populated <code>ResponsesGetAddressNonInscriptionUTXOData</code> instance.
   */
...
/**
 * @member {Array.<module:models/ResponsesNonInscriptionUTXO>} utxo
 */
