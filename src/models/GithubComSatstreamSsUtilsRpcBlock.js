...
export default class GithubComSatstreamSsUtilsRpcBlock {
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcBlock} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcBlock} The populated <code>GithubComSatstreamSsUtilsRpcBlock</code> instance.
   */
 ...
 * @member {Array.<module:models/GithubComSatstreamSsUtilsRpcBtcTx>} tx
 */
