...
export default class ResponsesGetBlockInfo {
   ...
   * @param {module:models/ResponsesGetBlockInfo} obj Optional instance to populate.
   * @return {module:models/ResponsesGetBlockInfo} The populated <code>ResponsesGetBlockInfo</code> instance.
   */
