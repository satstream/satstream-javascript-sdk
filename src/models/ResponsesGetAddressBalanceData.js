...
export default class ResponsesGetAddressBalanceData {
   ...
   * @param {module:models/ResponsesGetAddressBalanceData} obj Optional instance to populate.
   * @return {module:models/ResponsesGetAddressBalanceData} The populated <code>ResponsesGetAddressBalanceData</code> instance.
   */
