...
export default class GithubComSatstreamSsUtilsRpcVout {
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcVout} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcVout} The populated <code>GithubComSatstreamSsUtilsRpcVout</code> instance.
   */
