...
export default class GithubComSatstreamSsUtilsRpcUtxoRune {
   ...
   * @param {module:models/GithubComSatstreamSsUtilsRpcUtxoRune} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsRpcUtxoRune} The populated <code>GithubComSatstreamSsUtilsRpcUtxoRune</code> instance.
   */
