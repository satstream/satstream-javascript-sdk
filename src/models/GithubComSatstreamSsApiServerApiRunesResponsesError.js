 ...
 * @module models/GithubComSatstreamSsApiServerApiRunesResponsesError
 * @version 1.0
 */
export default class GithubComSatstreamSsApiServerApiRunesResponsesError {
   ...
   * @alias module:models/GithubComSatstreamSsApiServerApiRunesResponsesError
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/GithubComSatstreamSsApiServerApiRunesResponsesError} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsApiServerApiRunesResponsesError} The populated <code>GithubComSatstreamSsApiServerApiRunesResponsesError</code> instance.
   */
