 ...
 * @module models/GithubComSatstreamSsUtilsOrdinalsTermsRange
 * @version 1.0
 */
export default class GithubComSatstreamSsUtilsOrdinalsTermsRange {
   ...
   * @alias module:models/GithubComSatstreamSsUtilsOrdinalsTermsRange
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/GithubComSatstreamSsUtilsOrdinalsTermsRange} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsUtilsOrdinalsTermsRange} The populated <code>GithubComSatstreamSsUtilsOrdinalsTermsRange</code> instance.
   */
