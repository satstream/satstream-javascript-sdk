...
export default class ResponsesGetRunesInfoList {
   ...
   * @param {module:models/ResponsesGetRunesInfoList} obj Optional instance to populate.
   * @return {module:models/ResponsesGetRunesInfoList} The populated <code>ResponsesGetRunesInfoList</code> instance.
   */
...
/**
 * @member {module:models/ResponsesGetRunesInfoListData} data
 */
