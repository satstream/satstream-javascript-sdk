 ...
 * @module models/GithubComSatstreamSsApiServerApiTransactionsResponsesError
 * @version 1.0
 */
export default class GithubComSatstreamSsApiServerApiTransactionsResponsesError {
   ...
   * @alias module:models/GithubComSatstreamSsApiServerApiTransactionsResponsesError
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:models/GithubComSatstreamSsApiServerApiTransactionsResponsesError} obj Optional instance to populate.
   * @return {module:models/GithubComSatstreamSsApiServerApiTransactionsResponsesError} The populated <code>GithubComSatstreamSsApiServerApiTransactionsResponsesError</code> instance.
   */
